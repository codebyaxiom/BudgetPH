...
import { 
  ...
  Receipt, CheckCircle2, AlertCircle, Sparkles, X, Plus, Clock, 
              ...
              >
                ...
                <div className="space-y-1 my-1.5">
                  {dayBills.slice(0, 2).map(b => (
                    <div
                      key={b.id}
                      className={`truncate text-[10px] font-bold px-1.5 py-0.5 rounded-md flex items-center gap-1 ${
                        b.is_paid
                      ...
                      title={`${b.name}: ₱${Number(b.amount).toLocaleString()} (${b.is_paid ? 'Paid' : 'Pending'})`}
                    >
                  ...
                  {selectedDayBills.map(b => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        <span className="font-black text-xs text-slate-900 dark:text-slate-50 font-['Plus_Jakarta_Sans']">
                        ...
                        {b.is_paid ? (
                          ...
                          <button
                            ...
                            className="px-2.5 py-1 bg-emerald-600 hover:bg-emerald-700 text-white text-[11px] font-bold rounded-lg shadow-xs transition cursor-pointer"
                          >
