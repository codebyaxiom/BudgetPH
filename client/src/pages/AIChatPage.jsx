...
export function AIChatPage({ setActiveTab }) {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-slate-50/50 dark:bg-slate-950/40 relative select-text">
      ...
      <div className="h-14 border-b border-slate-200 dark:border-slate-800/80 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md px-4 sm:px-6 flex items-center justify-between gap-3 flex-shrink-0 z-10 select-none">
        ...
        <div className="flex items-center gap-2 overflow-x-auto">
          ...
          >
            ...
            <span>{daysUntilPayday}d {isTL ? 'Sahod' : 'Payday'}</span>
          </button>
          ...
          >
            ...
            <span>{unpaidBillsCount} {isTL ? 'Bills' : 'Bills'}</span>
          </button>
      ...
      <div className="px-4 sm:px-6 py-2.5 bg-slate-100/60 dark:bg-slate-900/60 border-b border-slate-200/80 dark:border-slate-800/80 flex items-center gap-2 overflow-x-auto select-none no-scrollbar">
          ...
          return (
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-bold transition flex items-center gap-1.5 flex-shrink-0 cursor-pointer ${
                isActive
                  ? 'bg-white dark:bg-slate-800 text-slate-900 dark:text-white shadow-sm border border-slate-200 dark:border-slate-700 scale-100'
